...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module, global) {/*!
	...
	;(function() {
	  ...
	  function runInContext(context) {
	    ...
	    function createFunction() {
	      ...
	      createFunction = function(args, body) {
	        var result,
	            anchor = __webpack_require__(3) ? __webpack_require__(4) : Benchmark,
	    ...
	    function req(id) {
	      try {
	        var result = freeExports && __webpack_require__(5)(id);
	      } catch(e) {}
	      return result || null;
	    }
	    ...
	    function runScript(code) {
	      var anchor = __webpack_require__(3) ? __webpack_require__(4) : Benchmark,
	  ...
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(9), __webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, platform) {
	      return runInContext({
	        '_': _,
	        'platform': platform
	      });
